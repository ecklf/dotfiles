    ...
    system.activationScripts.postActivation = {
      ...
      text = let
        ...
        patchDefaultApps = ''
          ...
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.colliderli.iina .mov all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.colliderli.iina .webm all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.colliderli.iina .flv all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.colliderli.iina .avi all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.colliderli.iina .mkv all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.colliderli.iina .m4v all
          ...
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.microsoft.VSCode .c all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.microsoft.VSCode .cpp all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.microsoft.VSCode .h all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.microsoft.VSCode .hpp all
          sudo -u ${username} ${pkgs.duti}/bin/duti -s com.microsoft.VSCode .java all
